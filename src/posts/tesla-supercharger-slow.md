...
<div class="tip-box">
<strong>Pro Tip:</strong> Even if you know where the Supercharger is, use navigation. This triggers automatic preconditioning that significantly improves charging speed.
</div>
...
<strong>Note:</strong> These are peak speeds achieved briefly at optimal state of charge and temperature. Average speeds across a full session will be lower.
</div>
