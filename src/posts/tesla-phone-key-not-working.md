...
<strong>Focus Mode:</strong> If you use Focus modes (Do Not Disturb, etc.), ensure they don't restrict the Tesla app's background activity.
</div>
...
<div class="tip-box">
<strong>Key Card Hack:</strong> Stick a key card to the back of your phone case. Acts as automatic backup without carrying anything extra.
</div>
