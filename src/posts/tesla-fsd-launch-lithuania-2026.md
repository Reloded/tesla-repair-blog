...
readTime: "9 min read"
models: "HW4 / AI4 (Model 3, Y, S, X)"
emoji: "🇱🇹"
faq:
  - q: "When did Tesla launch FSD in Lithuania?"
    a: "Tesla announced the expansion on May 19, 2026, and began rolling out FSD (Supervised) to Lithuanian owners on May 20, 2026. Lithuania is the second European country to receive the system, after the Netherlands."
  - q: "How much does FSD cost in Lithuania?"
    a: "FSD (Supervised) is subscription-only in Lithuania. The standard price is €99 per month. Owners who previously purchased Enhanced Autopilot (EAP) pay a reduced €49 per month. There is no one-time purchase option at launch — every Lithuanian user is on the monthly subscription model."
  - q: "Does my Tesla support FSD in Lithuania?"
    a: "At launch, only Hardware 4 (AI4) vehicles are supported. That means Model 3 and Model Y built after roughly late 2023 (Highland and Juniper refreshes), and newer Model S and Model X. Hardware 3 (HW3) vehicles cannot use FSD in Lithuania yet — Tesla has indicated an 'FSD v14 Lite' build is being prepared for HW3 cars, with rollout expected later in summer 2026. If you're unsure which hardware your car has, check the VIN report or the in-car software details under Controls > Software."
  - q: "How does FSD legally work in Lithuania?"
    a: "Lithuania approved FSD (Supervised) under UN Regulation R-171, which governs Driver Control Assistance Systems and classifies FSD as Level 2 automation. That means the driver must remain attentive at all times, keep hands available for immediate takeover, and retains full legal responsibility for the vehicle. Tesla's driver monitoring sensors enforce attentiveness — if the system detects persistent inattentiveness, FSD will temporarily lock out."
  - q: "Why was Lithuania approved so quickly?"
    a: "Lithuania didn't conduct its own 18-month independent testing program — instead, the Lithuanian Transport Safety Administration (LTSA) and the Ministry of Transport and Communications recognized the existing EU type-approval issued by the Dutch vehicle authority RDW in April 2026. Under EU mutual recognition rules, member states can accept another country's certification without restarting the approval process from scratch. This is the same pathway other EU countries are expected to follow in the coming months."
  - q: "Which EU countries are next for FSD?"
    a: "Tesla has indicated FSD (Supervised) will expand more rapidly across additional European countries in the second half of 2026, leveraging the Netherlands-issued pan-European type approval as a foundation. Greece and Belgium are publicly reported as working toward approval. Each country still needs to formally recognize the RDW certification through its own transport safety authority."
  - q: "Can I cancel my Tesla FSD subscription anytime?"
    a: "Yes. FSD (Supervised) in Europe is sold as a monthly subscription, so you can cancel at any time through your Tesla account. Some owners use month-by-month subscriptions for road trips or specific driving scenarios rather than committing year-round. Be aware that EAP-discounted pricing (€49/month) is only available if you already own Enhanced Autopilot — it cannot be added retroactively for cheaper FSD access."
tools:
  - name: "Samsung T7 Portable SSD 500GB (for dashcam + FSD recording)"
    link: "https://www.amazon.de/s?k=samsung+t7+ssd+500gb&tag=diyrepair-21"
    asin_de: "B087DDSXD3"
    asin_com: "B0874YS2N7"
    shopee_sg: "https://invl.me/clnfdp9"
  - name: "Tesla Model Y/3 Phone Mount (hands-on-wheel reminder)"
    link: "https://www.amazon.de/s?k=tesla+phone+mount&tag=diyrepair-21"
    asin_com: "B0CXCQWG11"
...
For these questions, the build sheet and original factory configuration tell the full story. The car's display only shows current hardware; a [VIN-based factory report](https://vintesla.com/?utm_source=tesladiyrepair&utm_medium=blog&utm_campaign=fsd_lithuania&utm_content=buyers_check) shows what the car was actually built with, what options were originally installed, and what software entitlements came with it.

## Related Guides

If you're new to Tesla in Lithuania, or just preparing for FSD-era driving, a few related guides on this site:

- [Tesla Autopilot Camera Calibration](/posts/tesla-autopilot-camera-calibration/) — FSD relies on the same camera array; miscalibrated cameras are the most common cause of FSD disengaging
- [Tesla Autopilot Unavailable: Common Fixes](/posts/tesla-autopilot-unavailable/) — what to check if FSD won't enable after subscription
- [Tesla Vision vs Radar vs Lidar Explained](/posts/tesla-vision-vs-radar-lidar/) — how Tesla's camera-only approach differs from competitors
- [Tesla Used Buying Inspection Guide](/posts/tesla-used-buying-inspection-guide/) — what to check before buying a used Tesla
- [Tesla Phantom Braking Fix](/posts/tesla-phantom-braking-fix/) — FSD will be more aggressive than basic Autopilot, including with phantom-brake events
- [Tesla Maintenance Schedule](/posts/tesla-maintenance-schedule/) — keep cameras and sensors in spec for FSD reliability
