...
<div class="info-box">
<strong>Model 3 and Model Y Owners:</strong> These models use key cards and phone keys instead of fobs. The key card has no battery—if it stops working, it may be damaged and needs replacement ($25 from Tesla).
</div>
...
<div class="tip-box">
<strong>Pro Tip:</strong> Buy a 10-pack of CR2032 batteries. They last 1-2 years in the fob, and you'll use them in other devices too. Much cheaper in bulk.
</div>
