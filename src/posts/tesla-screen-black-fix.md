...
emoji: "🖥️"
faq:
  - q: "Why did my Tesla screen go black?"
    a: "The most common cause is a software glitch that freezes the MCU (media control unit). This is almost never a hardware failure. A simple scroll wheel reboot fixes 90% of cases in about 60 seconds."
  - q: "How do I reboot a Tesla with a black screen?"
    a: "Hold both steering wheel scroll wheels down simultaneously for 10-15 seconds. The screen will go black, the Tesla logo will appear, and the system will restart. The car remains safe to drive during the reboot."
  - q: "Can I still drive my Tesla with a black screen?"
    a: "Yes. The car's drive systems (motor, brakes, steering, Autopilot) run independently from the touchscreen. You can safely drive to a safe location. Turn signals and voice commands may still work."
  - q: "What if the Tesla screen reboot doesn't work?"
    a: "Try a full power-off: go to Controls > Safety > Power Off, wait 5 minutes without touching anything, then press the brake pedal. If that fails, disconnect and reconnect the 12V battery. Persistent black screens may indicate MCU hardware failure."
  - q: "Does a black Tesla screen mean the MCU is dead?"
    a: "Usually not. Most black screen events are software crashes, not hardware failures. If rebooting fixes it and it doesn't recur frequently, your MCU is fine. Repeated daily black screens on MCU1 (pre-2018 Model S/X) may indicate eMMC flash memory wear."
tools:
...
<div class="info-box">
<strong>Good News:</strong> A frozen or black screen doesn't affect the car's ability to drive safely. Critical systems like steering, brakes, and motor control are on separate computers. You can drive to a safe location and then reboot.
</div>
...
<strong>Warning:</strong> Factory reset erases ALL data including:
- Driver profiles
- Saved addresses
- Bluetooth pairings
- WiFi networks
