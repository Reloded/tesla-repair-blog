...
<div class="tip-box">
<strong>Pro Tip:</strong> If your garage has weak WiFi, try parking closer to your router or using a WiFi extender. Some owners use a mobile hotspot for updates.
</div>
...
<strong>Important:</strong> Never try to drive during an update installation. The car will prevent this, but attempting to interrupt can cause issues.
</div>
