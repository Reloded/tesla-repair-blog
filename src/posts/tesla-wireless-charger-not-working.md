...
tools:
  ...
  - name: "MagSafe Compatible Phone Case"
    link: "https://www.amazon.de/s?k=magsafe+compatible+phone+case+tesla&tag=diyrepair-21"
  - name: "Aftermarket Tesla Wireless Charger (MagSafe)"
    link: "https://www.amazon.de/s?k=tesla+model+3+wireless+charger+magsafe&tag=diyrepair-21"
...
The center console wireless charger uses the Qi standard and delivers up to 15W of power. It has two charging pads — one for the driver's phone and one for the passenger's. The charger only works when the vehicle is powered on (touchscreen active), unless Sentry Mode or Camp Mode is keeping the system alive.

A few things to know upfront:

- The charger activates about 2-3 seconds after placing your phone
- Phones will get warm during wireless charging — that's normal for any Qi charger
...
- Switch to a thin, Qi-compatible case — most cases under 3mm work fine
...
Tesla's wireless charger lacks active cooling — there's no fan underneath the pad, unlike some newer EVs from other manufacturers. The charging coil generates heat, and in a sun-baked cabin, the phone can hit thermal limits quickly.

**The fix:**

- Turn on climate control or [Cabin Overheat Protection](/posts/tesla-climate-keeper-issues/) before getting in the car
- Put your phone in Low Power Mode before placing it on the charger — this reduces background processing and heat generation
- Remove the case while charging to allow better heat dissipation
- Avoid charging while running navigation and streaming simultaneously — all three generate significant heat
...
You place the phone down and nothing happens — no charging icon, no warmth, nothing.

**Step-by-step troubleshooting:**

1. **Check the car is on** — the touchscreen must be active. Sit in the driver's seat or press the brake pedal
2. **Remove everything from the pad** — key cards, coins, AirPods cases, or any other objects between the phone and charger surface
3. **Try the other pad** — if the passenger side works but the driver side doesn't, the issue is isolated to one charging coil
4. **Try a different phone** — this rules out a phone-side problem
5. **Reboot the touchscreen** — hold both scroll wheels on the steering wheel for about 10 seconds until the Tesla logo appears. This resets the MCU and can fix software glitches affecting the charger
6. **Check for software updates** — go to Controls > Software on the touchscreen. Some updates have addressed wireless charging bugs
...
- **Vibrations from driving** — the phone shifts slightly on the pad and loses alignment. A thin non-slip pad or MagSafe-compatible mount can help
- **Phone case is borderline too thick** — it works sometimes but not consistently. Try a thinner case
- **Software bug** — do a scroll wheel reboot (hold both wheels for 10 seconds)
- **Worn charging module** — if the issue persists across multiple phones and reboots, the module is likely failing
...
- OEM part number varies by year — **1541234-00-B** (pre-2024) and **1755100-00-D** (2024+) are common part numbers found on the Model 3 and Model Y
...
2. Remove the center console phone dock trim — use a plastic trim tool to gently pry up the rubber pad and surrounding trim
...
- Make sure the unit fits your specific model year — pre-2021, 2021-2023, and 2024+ Highland have different console designs
- Check reviews for your specific phone model — some chargers fit certain phone sizes better than others
...
- The charger worked fine, then suddenly died — could be a wiring harness issue
- Your vehicle is under warranty — wireless charger replacement is covered under the basic 4-year/50,000-mile warranty
