...
<div class="tip-box">
<strong>Pro Tip:</strong> Clean around the headliner area above the mirror monthly. Dust buildup can affect microphone pickup.
</div>
...
<strong>Note:</strong> Wake word uses more battery due to always-listening. Some owners disable it to reduce vampire drain.
</div>
