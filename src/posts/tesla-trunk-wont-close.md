...
<div class="tip-box">
<strong>Tip:</strong> Never use WD-40 on Tesla latches. Use silicone-based lubricant only, as petroleum products can damage rubber seals.
</div>
...
**Step 1: Locate the Striker**
The striker is the U-shaped metal piece on the car body that the trunk latch grabs onto.
...
<strong>Important:</strong> Make small adjustments only (1-2mm at a time). Large adjustments can cause the trunk to not seal properly, leading to water leaks.
</div>
