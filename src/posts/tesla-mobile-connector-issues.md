...
emoji: "🔌"
tools:
  - name: "NEMA 14-50 Outlet Tester"
    link: "https://www.amazon.de/s?k=NEMA+14-50+outlet+tester&tag=diyrepair-21"
  - name: "Multimeter"
    link: "https://www.amazon.de/s?k=digital+multimeter&tag=diyrepair-21"
  - name: "Tesla Mobile Connector Adapter Bundle"
...
<div class="tip-box">
<strong>Pro Tip:</strong> A loose outlet is a common cause of failure. If the plug wiggles in the outlet, the outlet needs replacement.
</div>
...
<strong>Important:</strong> Heat damage indicates a serious problem. A warm or hot outlet is dangerous. Have it inspected before continuing to use.
</div>
...
<div class="info-box">
<strong>Safety:</strong> If you're not comfortable testing electrical outlets, hire a licensed electrician. Working with 240V can be dangerous.
</div>
...
<div class="warning-box">
<strong>Never Use Extension Cords:</strong> Extension cords cause voltage drop, overheating, and fire risk. If you need to reach further, move the outlet or use a longer-range solution like a Wall Connector.
</div>
