...
faq:
  - q: "What should I do on day one with my new Tesla?"
    a: "Set up your phone key, connect Wi-Fi, configure your driver profile (seat, mirrors, steering wheel), set your charge limit to 80% for daily use, and install the Tesla app on your phone. Then take a short drive to get used to regenerative braking before heading into traffic."
  - q: "What accessories do I actually need for a new Tesla?"
    a: "Screen protector, all-weather floor mats, and a USB SSD for Sentry Mode and dashcam are the three essentials. Everything else is nice-to-have. Mud flaps are highly recommended if you live somewhere with rain, snow, or gravel roads."
  - q: "How often does a Tesla need maintenance?"
    a: "Much less than a gas car. Cabin air filter every 2-3 years, brake fluid test every 2 years, tire rotation every 10,000-12,000 km, and that's about it for routine items. No oil changes, no spark plugs, no transmission fluid. See our full maintenance schedule for details."
  - q: "Should I charge my Tesla every night?"
    a: "If you can, yes - but don't charge above 80% for daily driving. Tesla recommends keeping the car plugged in when not in use. The car manages its own battery health, and plugging in lets it use wall power instead of stored energy for thermal management."
  - q: "Is it OK to use third-party Superchargers?"
    a: "Yes. Many third-party DC fast chargers work with Tesla's CCS port (or CCS adapter for older Teslas). Ionity, Fastned, and others are all compatible. Tesla's built-in navigation will show both Tesla Superchargers and compatible third-party chargers."
  - q: "What's the best charge limit for daily driving?"
    a: "80% is the sweet spot for most people. If you have a short commute, 70% works too. Only charge to 100% before long trips, and try to start driving soon after reaching 100%. LFP battery owners (check your owner's manual) can charge to 100% daily without concern."
---
...
**Recommended:** A 500GB-1TB USB SSD. Samsung T7, SanDisk Extreme, or any reliable brand. Expect to pay €50-100 for something that'll last the life of the car. See our guide on [formatting USB drives for Tesla](/posts/format-usb-tesla-dashcam/).
...
| Task | Interval | DIY? |
|------|----------|------|
| [Cabin air filter](/posts/tesla-cabin-air-filter/) | Every 2-3 years | ✅ Easy, 10 min |
| [Brake fluid test](/posts/tesla-brake-fluid-change/) | Every 2 years | ✅ Moderate |
| [Tire rotation](/posts/tesla-tire-rotation/) | Every 10,000-12,000 km | ✅ Easy with jack |
| [Wiper blades](/posts/tesla-windshield-wiper-replacement/) | Annually or as needed | ✅ Easy, 5 min |
| Coolant check | Every 4-6 years | ⚠️ Best left to pros |
| [Brake pad inspection](/posts/tesla-brake-pad-replacement/) | Every 20,000 km | ✅ Visual check |
...
7. **Download the owner's manual.** Seriously. There's a digital copy in the touchscreen (tap the Tesla "T" logo > Owner's Manual), and you can access it at [tesla.com/ownersmanual](https://www.tesla.com/ownersmanual). It's well-written and covers things no third-party guide can.
