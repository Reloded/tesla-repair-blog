...
emoji: "⚠️"
faq:
  - q: "What does the red car icon with an exclamation mark mean on Tesla?"
    a: "A red car icon with an exclamation mark indicates a critical vehicle error — usually a powertrain, high-voltage battery, or safety system failure. Pull over safely when possible and contact Tesla Service. Do not ignore red warnings."
  - q: "Why does my Tesla say 'Regenerative braking limited'?"
    a: "This appears when the battery is too cold or too full for regen braking. It's normal in cold weather or right after charging to 100%. The dotted line on the power bar shows reduced regen. Drive gently until the battery warms up — usually 10-20 minutes."
  - q: "What does 'Autopilot Unavailable' mean on Tesla?"
    a: "This means one or more cameras or sensors can't function properly. Common causes: dirty cameras, extreme weather (fog, heavy rain, direct sun), recent windshield replacement, or a camera malfunction. Clean the cameras first. If it persists, try a scroll wheel reboot."
  - q: "Should I keep driving if Tesla shows a yellow warning?"
    a: "Yellow/amber warnings are caution alerts — your car is usually still drivable but something needs attention soon. Common yellow alerts include tire pressure, service reminders, and minor system limitations. Schedule service when convenient, but you don't need to pull over."
  - q: "How do I clear warning messages on my Tesla screen?"
    a: "Most warnings clear automatically when the underlying issue is resolved. For persistent alerts, try a scroll wheel reboot (hold both scroll wheels 10 seconds). If warnings return after reboot, the issue is real and needs diagnosis. Check the Service menu for fault codes."
  - q: "What does 'Car may not restart' mean on Tesla?"
    a: "This is a critical 12V battery warning. Your main drive battery is fine, but the 12V auxiliary battery that powers the computers is dying. Drive directly to a charger or service center. If the 12V battery dies completely, the car won't wake up at all."
tools:
...
### 🔴 Red Alerts — Critical
**Action:** Pull over safely. Do not ignore.
Red warnings indicate immediate safety concerns or critical system failures. These might limit your ability to drive or signal something that could damage the vehicle.

### 🟡 Yellow/Amber Alerts — Caution
**Action:** Schedule service soon. Usually safe to keep driving.
Yellow warnings mean something needs attention but isn't an emergency. Your car is still drivable, but the issue should be addressed within days or weeks.

### ⚪ White/Grey Informational — Notice
**Action:** Read and acknowledge. Usually no action needed.
These are status updates, reminders, or feature notifications. They're informational, not warnings.
...
**Related guide:** [Tesla Acceleration Issues & Power Loss Troubleshooting](/posts/tesla-acceleration-issues/)
...
4. If the car won't start, you'll need to [jump the 12V battery](/posts/tesla-12v-battery-replacement/)

**Common in:** Pre-2021 Model 3/Y with lead-acid 12V batteries. Less common in 2021+ with lithium 12V.

**Related guide:** [Tesla 12V Battery Replacement Guide](/posts/tesla-12v-battery-replacement/)
...
**Related guides:**
- [Tesla Battery Health & Degradation Guide](/posts/tesla-battery-degradation-health/)
- [Tesla Coolant Leak Diagnosis & Fix](/posts/tesla-coolant-leak-fix/)
...
**Related guide:** [Tesla Brake Pad Replacement Guide](/posts/tesla-brake-pad-replacement/)
...
**Related guide:** [Tesla Power Steering Issues](/posts/tesla-power-steering-issues/)
...
- [Preconditioning your battery](/posts/tesla-battery-preconditioning-guide/) before driving helps in winter

**Related guide:** [Tesla Regen Braking Reduced or Not Working](/posts/tesla-regen-braking-reduced/)
...
**Related guides:**
- [Tesla Tire Pressure Guide](/posts/tesla-tire-pressure-guide/)
...
**Related guides:**
- [Tesla Autopilot Camera Calibration Guide](/posts/tesla-autopilot-camera-calibration/)
- [Tesla Autopilot Unavailable Fix](/posts/tesla-autopilot-unavailable/)
- [Tesla Side Repeater Camera Replacement](/posts/tesla-side-repeater-camera-replacement/)
...
4. You can [replace the 12V battery yourself](/posts/tesla-12v-battery-replacement/) for a fraction of Tesla Service cost
...
**Related guides:**
- [Tesla Charge Port Stuck or Won't Open](/posts/tesla-charge-port-stuck/)
- [Tesla Charging Port Replacement](/posts/tesla-charging-port-replacement/)
...
**Related guides:**
- [Tesla Headlight Replacement Guide](/posts/tesla-headlight-replacement/)
- [Tesla Tail Light Replacement Guide](/posts/tesla-tail-light-replacement/)
- [Tesla Headlight Condensation Fix](/posts/tesla-headlight-condensation/)
...
**Related guide:** [Tesla Software Update Stuck or Failed](/posts/tesla-software-update-stuck/)
...
**Causes & fixes:**
- **Home outlet overheating:** Use a dedicated circuit for Tesla charging. [Wall Connector is the best solution](/posts/tesla-wall-connector-installation/)
...
- **Mobile Connector issue:** Try a different outlet. [Check the Mobile Connector](/posts/tesla-mobile-connector-issues/)
...
**Fixes:**
- **Too cold:** [Precondition the battery](/posts/tesla-battery-preconditioning-guide/) before charging, or just let it slow-charge (it'll warm up)
...
**Related guide:** [Tesla Slow Charging Fix — All Causes](/posts/tesla-slow-charging-fix/)
...
**Related guide:** [Tesla Charge Port Stuck or Won't Open](/posts/tesla-charge-port-stuck/)
...
**Related guide:** [Tesla AC & Heater Not Working](/posts/tesla-ac-heater-not-working/)
...
**Related guides:**
- [Tesla Heat Pump Problems & Fixes](/posts/tesla-heat-pump-problems/)
...
**Related guide:** [Tesla Screen Frozen — How to Reboot](/posts/tesla-screen-frozen-reboot/)

### Step 2: Check Service Mode
Go to Controls → Service → check for any stored alerts or fault codes. Note the exact wording.

**Related guide:** [Tesla Service Mode Guide](/posts/tesla-service-mode-guide/)

### Step 3: Use an OBD2 Scanner
For deeper diagnostics, an [OBD2 scanner compatible with Tesla](/posts/tesla-obd2-scanner-diagnostics/) can read specific fault codes, battery cell voltages, and module status.
...
Most Tesla owners will only see yellow and white alerts during normal ownership. If you maintain your car properly — regular [tire pressure checks](/posts/tesla-tire-pressure-guide/), [12V battery monitoring](/posts/tesla-12v-battery-replacement/), and [following the maintenance schedule](/posts/tesla-maintenance-schedule/) — critical red warnings are rare.
