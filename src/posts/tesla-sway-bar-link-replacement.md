---
layout: post.njk
title: "Tesla Sway Bar Link Replacement: Fix That Clunking Noise"
description: "Fix clunking and knocking noises from worn sway bar links on Tesla Model 3 and Model Y. Complete DIY replacement guide with torque specs and part numbers."
date: 2026-02-06
category: "Suspension"
difficulty: "Medium"
...
tools:
  ...
  - name: "15mm Socket and Wrench"
    link: "https://www.amazon.de/s?k=15mm+socket+wrench&tag=diyrepair-21"
  - name: "T40 Torx Bit"
    link: "https://www.amazon.de/s?k=T40+torx+bit&tag=diyrepair-21"
  - name: "Torque Wrench (up to 200 Nm)"
    link: "https://www.amazon.de/s?k=torque+wrench+200nm&tag=diyrepair-21"
  - name: "Tesla Sway Bar Links (Pair)"
    link: "https://www.amazon.de/s?k=tesla+model+3+sway+bar+link&tag=diyrepair-21"
  - name: "Tesla Sway Bar Links (Original OEM)"
    link: "https://rrcarparts.com/collections/all?q=stabilizer+link"
    provider: "rrcarparts"
...
The noise from worn links has a higher-pitched "clunk" compared to the lower "thud" you'd hear from worn sway bar bushings. If you can't pinpoint whether it's links or bushings, check both — but links fail more often.

<div class="tip-box">
<strong>Quick diagnosis:</strong> Have someone push down on the fender while you look at the sway bar link. If you see any movement or play in the ball joints, replace them.
</div>
...
<strong>Note for Model 3 SR/SR+:</strong> Standard Range models didn't come with a rear sway bar from the factory. If you're adding one aftermarket, you'll need rear links plus mounting hardware.
</div>
...
If the stud just spins and you can't get a T40 in there, you may need to cut the link off. Use a reciprocating saw or angle grinder if needed — you're replacing it anyway.
...
- Check other suspension components like [control arms](/posts/tesla-control-arm-replacement/)
...
**New nuts matter.** Tesla specifies new hardware at reassembly because the nylon insert in the lock nuts gets compressed. Reused nuts may not hold torque properly. New nuts are cheap — just get them.
...
- [Control Arm Replacement](/posts/tesla-control-arm-replacement/) — If your clunking continues after link replacement
- [Suspension Noise Fix](/posts/tesla-suspension-noise-fix/) — Diagnose other noise sources
- [Jack Points & Lifting Guide](/posts/tesla-jack-points-lifting-guide/) — Safely lift your Tesla
- [Strut Replacement](/posts/tesla-strut-replacement/) — For worn dampers
