...
faq:
  ...
  - q: "How long does it take to Supercharge on a road trip?"
    a: "A typical Supercharger stop takes 15-25 minutes if you arrive at 10-20% and charge to 60-80%. Charging from 10% to 80% on a V3 Supercharger takes about 25-30 minutes for most models. Charging above 80% slows dramatically and isn't worth the wait on road trips."
  - q: "Do I need to plan my route around Superchargers?"
    a: "Tesla's built-in trip planner does this automatically. Enter your destination and the car adds Supercharger stops, estimates arrival charge levels, and accounts for elevation and weather. You can also use A Better Route Planner (ABRP) for more detailed planning."
  - q: "What if there's no Supercharger where I need one?"
    a: "Use third-party charging networks (Ionity, Electrify America, Fastned) or destination chargers at hotels. In Europe, CCS adapters are built into newer Teslas. The Tesla app and ABRP show all available chargers, not just Tesla's network."
---
...
- Begins [battery preconditioning](/posts/tesla-battery-preconditioning-guide/) as you approach each charger

**How to use it:**

1. Tap the navigation bar on your touchscreen
2. Enter your final destination
3. The car shows the route with charging stops marked
4. Blue battery icons show planned Supercharger stops
5. The estimated arrival percentage at each stop is shown

<div class="tip-box">
<strong>Trust the car's estimates.</strong> Tesla's trip planner accounts for your current driving efficiency, outside temperature, elevation changes, and even headwind estimates. It's surprisingly accurate after the first 30 minutes of driving when it calibrates to your actual consumption.
</div>

### A Better Route Planner (ABRP)

For more detailed planning, [A Better Route Planner](https://abetterrouteplanner.com/) is the gold standard among EV road trippers.
...
1. **Assume 70-80% of rated range at highway speeds** - A 500 km rated range becomes 350-400 km real range at 120-130 km/h
2. **Plan to arrive at Superchargers with 10-20%** - This puts you in the fastest charging zone
3. **Don't charge above 80% at Superchargers** - The last 20% takes almost as long as the first 80%
4. **Budget 20-30 minutes per charging stop** - Enough for a bathroom break, snack, and a stretch
5. **Have a backup charger in mind** - If a Supercharger is full or broken, know where the next one is
...
For more on slow charging at Superchargers, see our [Supercharger slow charging guide](/posts/tesla-supercharger-slow/).
...
- Set cabin temp to 20-21°C instead of 24°C for meaningful energy savings.

**Tires and pressure:**
- Check tire pressure before departure. Under-inflated tires increase rolling resistance significantly. See our [tire pressure guide](/posts/tesla-tire-pressure-guide/).
...
For detailed range troubleshooting, see our [range loss fix guide](/posts/tesla-range-loss-fix/).

## Pre-Trip Checklist

### The Night Before

1. **Charge to 100%** (or 90% for NCA/NMC batteries if you prefer). For LFP batteries, 100% is always fine.
2. **Check tire pressure** - Cold pressure, ideally in the morning before driving. See our [tire pressure guide](/posts/tesla-tire-pressure-guide/).
3. **Clean cameras** - Dirty cameras mean degraded Autopilot. All 8 (or 9 on newer models). See our [camera calibration guide](/posts/tesla-autopilot-camera-calibration/).
4. **Update software** - If an update is pending, install it the night before, not during the trip. See [software update guide](/posts/tesla-software-update-stuck/) if it's stuck.
5. **Format dashcam USB** - Make sure [Sentry Mode and dashcam](/posts/tesla-dashcam-usb-setup/) are recording properly. You want footage on road trips.
6. **Set up navigation** - Plan your route in ABRP or Tesla nav. Download offline maps if heading to remote areas.
7. **Precondition with Scheduled Departure** - Set your departure time so the car is warm and ready.
...
For Autopilot issues, see our [Autopilot unavailable fix](/posts/tesla-autopilot-unavailable/).
...
1. **Pull in, plug in** - Don't sit in the car checking your phone first
2. **Bathroom and stretch** while the car charges the fastest (first 10-15 minutes)
3. **Grab food/drink** - By the time you're back, you're often at 60-70%
4. **Check the app** - See current charge level from inside the rest stop
5. **Unplug and go** at 60-80% - Don't wait for 100%
...
<div class="tip-box">
<strong>Always bring your Mobile Connector.</strong> Even a standard wall outlet (Schuko in Europe, NEMA 5-15 in the US) gives you a meaningful charge overnight. Many hotel parking garages have accessible outlets near maintenance areas - ask the front desk.
</div>
...
- Use [Camp Mode](/posts/tesla-dog-mode-camp-mode/) sparingly - it uses 1-2 kWh per hour
...
1. **Precondition before departure** - Use Scheduled Departure so the cabin and battery are warm
2. **Always navigate to Superchargers** - Triggers automatic [battery preconditioning](/posts/tesla-battery-preconditioning-guide/) for faster charging
3. **Use seat heaters over cabin heat** - Much more efficient
4. **Charge more frequently** - Don't try to stretch to the next charger in cold weather
5. **Keep the charge port clear of ice** - See our [winter preparation guide](/posts/tesla-winter-preparation-guide/)
...
1. **Slow down** - Drop to 80-90 km/h. This alone can add 30-50 km of range.
2. **Turn off climate** - Use seat heaters only if cold
3. **Close windows** - Open windows at highway speed destroy aerodynamics
4. **Avoid unnecessary acceleration** - Smooth, steady driving
5. **Check for closer alternatives** - Third-party CCS chargers, destination chargers, or even a regular outlet at a restaurant
...
1. **Tire repair kit** - Tesla includes a basic sealant kit. It works for small punctures.
2. **Tesla Roadside Assistance** - Available through the app 24/7. They'll bring a loaner wheel or tow you to a tire shop.
3. **Your own portable inflator** - Re-inflate slowly and drive carefully to the nearest tire shop.

### 12V Battery Dies on the Road

Rare but possible, especially on older Teslas. See our [12V battery replacement guide](/posts/tesla-12v-battery-replacement/) and always have your jumper cables or a portable jump pack accessible (in the frunk, not the trunk).
...
- Europe: €0.35-0.55 per kWh (€15-25 per charging stop)
- US: $0.35-0.50 per kWh ($10-20 per charging stop)

**Compared to gas:**
A 1,000 km road trip in a Tesla costs roughly €40-70 in Supercharging. The same trip in a comparable gas car costs €100-150+ in fuel. The savings add up fast on longer trips.
...
- [Tesla Battery Preconditioning](/posts/tesla-battery-preconditioning-guide/) - Faster charging in cold weather
- [Tesla Supercharger Slow](/posts/tesla-supercharger-slow/) - Why charging speeds vary
- [Tesla Slow Charging Fix](/posts/tesla-slow-charging-fix/) - Diagnose all charging issues
- [Tesla Range Loss Fix](/posts/tesla-range-loss-fix/) - Maximize your range
- [Tesla Tire Pressure Guide](/posts/tesla-tire-pressure-guide/) - Correct PSI for every model
- [Tesla Winter Preparation Guide](/posts/tesla-winter-preparation-guide/) - Cold weather essentials
- [Tesla Dog Mode & Camp Mode](/posts/tesla-dog-mode-camp-mode/) - Overnight comfort features
- [Tesla Autopilot Unavailable](/posts/tesla-autopilot-unavailable/) - Fix Autopilot for road trips
- [Tesla Dashcam USB Setup](/posts/tesla-dashcam-usb-setup/) - Record your journey
