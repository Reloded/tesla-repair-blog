...
emoji: "💧"
tools:
  - name: "Automotive Seam Sealer (Polyurethane)"
    link: "https://www.amazon.de/s?k=automotive+seam+sealer+polyurethane&tag=diyrepair-21"
  - name: "Silicone Sealant (Clear, Automotive Grade)"
    link: "https://www.amazon.de/s?k=clear+automotive+silicone+sealant&tag=diyrepair-21"
  - name: "Trim Removal Tool Set"
    link: "https://www.amazon.de/s?k=trim+removal+tool+set+automotive&tag=diyrepair-21"
  - name: "T30 Torx Bit Socket"
    link: "https://www.amazon.de/s?k=T30+torx+bit+socket&tag=diyrepair-21"
  ...
  - name: "Caulking Gun"
    link: "https://www.amazon.de/s?k=caulking+gun+automotive&tag=diyrepair-21"
...
This is the big one. During manufacturing, Tesla applies seam sealer where metal panels overlap inside the trunk lid. On many cars — especially early Model 3 builds from 2017-2020 — there are gaps or skips in this sealant. Water gets past the outer trunk seal, travels along the sheet metal seams, and pools inside the trunk lid or drips into the trunk well.
...
Tesla released a fix for this on the Model Y — a thicker gasket that provides a better seal. Signs of a tail light leak:
...
1. **Dry the trunk completely.** Wipe everything down and lay paper towels in the trunk well and along the edges.
2. **Have someone spray water** with a garden hose (gentle stream, not power washer) along the trunk seal, tail lights, and rear window area. Start from the bottom and work up.
3. **Check inside every 30 seconds.** The paper towels will show you exactly where water is entering.
4. **Check inside the trunk lid.** Pop off the inner trunk lid panel (it pulls off with trim clips) and look for water running along seams.
...
1. **Open the trunk and remove the inner trunk lid panel.** On the Model 3, this panel is held by push clips around the perimeter. Use a trim removal tool to carefully pry each clip free. On the Model Y liftgate, you'll need to remove similar trim panels to access the inner structure.

2. **Remove the factory foam pieces.** Tesla's service bulletin calls out two foam pieces (one on each side) located under the lamp can panels inside the trunk lid. Pull these out — they trap water instead of blocking it.

3. **Clean the seam areas.** Wipe down all the metal seams with isopropyl alcohol. You need a clean, dry surface for the sealant to bond properly. Pay close attention to:
...
4. **Apply seam sealer.** Run a bead of polyurethane sealant along every metal-to-metal seam inside the trunk lid. Focus on:
   ...
   - Small holes or openings in the sheet metal (these should not be there — seal them)

5. **Let it cure.** Most automotive sealants need 24-48 hours to fully cure. Don't close the trunk lid or get it wet during this time.

6. **Water test again.** After curing, repeat the hose test to verify the leak is fixed.

7. **Reinstall the inner panel.** Press the push clips back into place. Skip reinstalling the foam pieces — they're not doing anything useful.

## Fix 2: Tail Light Reseal

If your water test pointed to the tail light area:

1. **Open the trunk** and locate the tail light mounting hardware. On the Model 3, each tail light is secured with T30 Torx fasteners accessible from inside the trunk.

2. **Remove the tail light.** Unscrew the fasteners and carefully pull the light straight back. Disconnect the wiring harness.

3. **Inspect the gasket.** Look for compression damage, tears, or areas where the gasket has gone flat. If the gasket looks worn, replace it. Tesla sells replacement gaskets, or you can find aftermarket options.

4. **Clean the mounting surface.** Wipe both the body panel surface and the light housing with isopropyl alcohol.

5. **Apply sealant to seams behind the light.** With the light removed, inspect the body seams that are normally hidden. Apply seam sealer to any gaps where the metal overlaps — this is a very common entry point that people miss.

6. **Reinstall the tail light.** Make sure the gasket seats evenly all the way around and tighten the fasteners snugly. Don't overtighten — you'll crush the gasket and create a new leak path.

7. **Water test** to confirm the fix.
...
1. Carefully peel back the rubber windshield trim at the A-pillar
2. Clean the gap with isopropyl alcohol
3. Apply a thin bead of clear automotive silicone sealant
4. Press the trim back into place
5. Let cure 24 hours before water testing

For persistent A-pillar leaks, a Tesla service appointment is the better move. The windshield may need to be reseated — that's not a DIY job.

## Fix 4: Liftgate Weatherstrip (Model Y)

For Model Y liftgate leaks, start with the simple fix:

1. **Inspect the weatherstrip** all the way around the liftgate opening. Look for sections that appear crushed, folded, or pulled away from the body.
2. **Reseat any loose sections.** The weatherstrip sits in a channel — push it firmly back into place.
3. **Check the liftgate alignment.** If the gap between the liftgate and body is uneven, the seal won't compress evenly. Liftgate striker adjustment can help, but major alignment issues need professional attention.
4. **Replace the seal if damaged.** The full weatherstrip is available as a replacement part. It pulls out of the channel and the new one presses in.
...
- **The car is still under warranty** — trunk lid water ingress is a known manufacturing issue and Tesla should fix it for free
...
|-----|----------|---------------|
| Trunk lid seam sealing | €15-25 (sealant + supplies) | €100-300 |
| Tail light reseal/gasket | €10-30 | €80-150 |
| Weatherstrip replacement | €40-80 (part) | €150-250 |
| A-pillar/windshield reseal | €10-20 (sealant) | €200-500 |

## Reference

- **Tesla Service Bulletin SB-23-10-002:** "Reseal Trunk Lid to Prevent Water Ingress" — applies to Model Y, details the factory seam sealer gap fix
