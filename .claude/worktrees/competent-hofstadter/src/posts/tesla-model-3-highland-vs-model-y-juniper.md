...
faq:
  - q: "What's the main difference between Highland and Juniper?"
    a: "Highland is the refreshed Model 3 sedan (launched late 2023/early 2024), while Juniper is the refreshed Model Y crossover SUV (launched January 2025). Both share the 15.4-inch screen, ventilated seats, and 8-inch rear display, but the Model Y is bigger, has more cargo space (76 vs 24 cu ft), and brought back the turn signal stalk that the Model 3 removed."
  - q: "Which has better range — Highland or Juniper?"
    a: "The Model 3 Highland wins on range. The Long Range AWD gets an EPA-estimated 346 miles vs the Model Y Juniper's 327 miles. Both base RWD trims share the same 321-mile range. The Model 3's lower weight and better aerodynamics (0.219 Cd vs 0.22 Cd) give it the edge in efficiency."
  - q: "Does the Model Y Juniper have turn signal stalks?"
    a: "Yes — the Juniper brought back the traditional turn signal stalk on the steering column. The Model 3 Highland removed all stalks and uses steering wheel buttons instead, which has been controversial among owners."
  - q: "Which is better for a family — Model 3 Highland or Model Y Juniper?"
    a: "The Model Y Juniper is the better family vehicle. It offers 76 cubic feet of cargo space vs 24, a higher ride height for easier child seat installation, a hatchback trunk for strollers and gear, and overall more interior room. The Model 3 is better for couples or solo drivers who prioritize range and sportiness."
tools: []
---
...
If yes → Model Y Juniper.
If no → Model 3 Highland (and pocket the savings).
