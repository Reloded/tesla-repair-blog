---
layout: post.njk
title: "Tesla Glove Box Latch Fix: Won't Open or Close"
description: "Fix a Tesla glove box that won't open or stay closed. Common latch clip failure with easy DIY repair. No tools needed for most fixes."
date: 2026-02-11
category: "Interior"
difficulty: "Beginner"
readTime: "8 min read"
...
tools:
  ...
  - name: "Small Flathead Screwdriver"
    link: "https://www.amazon.de/s?k=small+flathead+screwdriver&tag=diyrepair-21"
...
4. **Don't force it** — the latch mechanism is plastic and breaks easily

### Fix 3: Check the USB Hub

On 2021+ Model 3/Y, the USB hub is inside the glove box. If the USB hub has a fault, it can sometimes affect the glove box latch circuit. Check if your [USB ports are working](/posts/tesla-usb-not-working/).
...
**Skill Level:** Beginner — no special tools required for most fixes

**Parts:**

- **Glove box latch assembly** (~$15–40) — available from Tesla parts suppliers and Amazon
- **Latch clip only** (~$5–10) — if you can find just the clip, it's all you need
...
2. On Model 3/Y, the glove box door has a damper arm on the right side — unhook it by sliding the clip
3. The door is held by two hinge pins at the bottom — push them inward or slide to release
4. Lift the door out
...
2. Compare with the new one — confirm it's identical
3. Install the new latch in the same position
4. Reconnect the electrical connector
5. Test before reassembling — tap the glove box button on the touchscreen and confirm the latch clicks
...
4. Close the glove box and test several times:
   - Opens when tapped on screen ✅
   - Stays closed while driving ✅
   - Closes smoothly without force ✅
...
3. If voltage is present but no click → solenoid is dead → replace the entire latch assembly
4. If no voltage → the issue is upstream (wiring, touchscreen MCU, or fuse)

<div class="info-box">
<strong>Fuse Check:</strong> The glove box latch shares a fuse circuit with other interior accessories. If multiple interior features are dead, check the fuse panel under the rear seat.
</div>

## Related Guides

- [Tesla USB Not Working](/posts/tesla-usb-not-working/) — USB hub inside glove box can cause issues
- [Tesla Screen Black Fix](/posts/tesla-screen-black-fix/) — Can't open glove box if screen is dead
- [Tesla Interior Cleaning & Detailing](/posts/tesla-interior-cleaning-detailing/) — Keep mechanisms clean
- [Tesla Dashcam USB Setup](/posts/tesla-dashcam-usb-setup/) — USB hub access in glove box
- [Tesla 12V Battery Replacement](/posts/tesla-12v-battery-replacement/) — Weak 12V causes intermittent issues
